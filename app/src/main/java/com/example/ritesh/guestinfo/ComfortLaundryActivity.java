...
public class ComfortLaundryActivity extends AppCompatActivity {
    ...
    @BindView(R.id.rlmain_comfort_laundry)
    RelativeLayout rlcomfort_laundry;

    @BindView(R.id.tv_comfort_laundry)
    TextView TVcomfort_laundry;

    String com_laun_details;
    DatabaseHandler db = new DatabaseHandler(this);


    @BindView(R.id.tv_comfort_laundry_aoname)
    TextView tvwelcome_accomodation;
    @BindView(R.id.iv_comfort_laundry_image_one)
    ImageView aoImageOne;
    @BindView(R.id.iv_comfort_laundry_image_two)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comfort_laundry);
        ...
        for (Contact cn : contacts) {
            String log =
                    "Id: " + cn.getID()
                            ...
                            + " ,getcom_laun_details: " + cn.getcom_laun_details()
                            + " ,geta_logo_image: " + cn.geta_logo_image()
                            + " ,geta_picture_image: " + cn.geta_picture_image()
                            + " ,getname: " + cn.getname();
            // Writing Contacts to log
            Log.e(" ^^^^^^ ^^^^^^^ ^^^ Comfort Laundry Sqlite data ^^^^^^ ^^^^^^^ ^^^ : ", log);

            com_laun_details = cn.getcom_laun_details();
...
//                    tvwelcomparent.setText(Html.fromHtml(a_welcome));
            ...
            if (com_laun_details !=null  && !com_laun_details.isEmpty()){
                Log.e("com_laun_details is NOT null :", "YES");
                TVcomfort_laundry.setText(com_laun_details);
            }else {
                rlcomfort_laundry.setVisibility(View.GONE);
                Log.e("com_laun_details is null :", "YES");
            }
