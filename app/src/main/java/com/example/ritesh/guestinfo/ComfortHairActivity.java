...
public class ComfortHairActivity  extends AppCompatActivity {
    ...
    @BindView(R.id.rlmain_comfort_hair)
    RelativeLayout rlcomfort_hair;

    @BindView(R.id.tv_comfort_hair)
    TextView TVcomfort_hair;

    String com_hair_details;
    DatabaseHandler db = new DatabaseHandler(this);


    @BindView(R.id.tv_comfort_hair_image_aoname)
    TextView tvwelcome_accomodation;
    @BindView(R.id.iv_comfort_hair_image_one)
    ImageView aoImageOne;
    @BindView(R.id.iv_comfort_hair_image_two)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comfort_hair);
        ...
        for (Contact cn : contacts) {
            String log =
                    "Id: " + cn.getID()
                            ...
                            + " ,getcom_hair_details: " + cn.getcom_hair_details()
                            + " ,geta_logo_image: " + cn.geta_logo_image()
                            + " ,geta_picture_image: " + cn.geta_picture_image()
                            + " ,getname: " + cn.getname();
            // Writing Contacts to log
            Log.e(" ^^^^^^ ^^^^^^^ ^^^ Comfort Hair Sqlite data ^^^^^^ ^^^^^^^ ^^^ : ", log);

            com_hair_details = cn.getcom_hair_details();
...
//                    tvwelcomparent.setText(Html.fromHtml(a_welcome));
            ...
            if (com_hair_details !=null  && !com_hair_details.isEmpty()){
                Log.e("com_hair_details is NOT null :", "YES");
                TVcomfort_hair.setText(com_hair_details);
            }else {
                rlcomfort_hair.setVisibility(View.GONE);
                Log.e("com_hair_details is null :", "YES");
            }

            Log.e(" << SQLite DATA FOR com_hair_details  >>: ", "" + log);
