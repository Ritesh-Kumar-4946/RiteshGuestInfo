...
public class ComfortLugageServicesActivity extends AppCompatActivity {
    ...
    @BindView(R.id.rlmain_comfort_lugage_services)
    RelativeLayout rlcomfort_lugage_services;
    @BindView(R.id.tv_comfort_lugage_services)
    TextView TVcomfort_lugage_services;

    String com_lug_details;
    DatabaseHandler db = new DatabaseHandler(this);


    @BindView(R.id.tv_comfort_lugage_aoname)
    TextView tvwelcome_accomodation;
    @BindView(R.id.iv_comfort_lugage_image_one)
    ImageView aoImageOne;
    @BindView(R.id.iv_comfort_lugage_image_two)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comfort_lugage_services);
        ...
        for (Contact cn : contacts) {
            String log =
                    "Id: " + cn.getID()
                            ...
                            + " ,getcom_lug_details: " + cn.getcom_lug_details()
                            + " ,geta_logo_image: " + cn.geta_logo_image()
                            + " ,geta_picture_image: " + cn.geta_picture_image()
                            + " ,getname: " + cn.getname();
            // Writing Contacts to log
            Log.e(" ^^^^^^ ^^^^^^^ Comfort Luggage Sqlite Data ^^^^^^ ^^^^^^^ ^^^ : ", log);

            com_lug_details = cn.getcom_lug_details();
...
//                    tvwelcomparent.setText(Html.fromHtml(a_welcome));
            ...
            if (com_lug_details !=null  && !com_lug_details.isEmpty()){
                Log.e("com_lug_details is NOT null :", "YES");
                TVcomfort_lugage_services.setText(com_lug_details);
            }else {
                rlcomfort_lugage_services.setVisibility(View.GONE);
                Log.e("com_lug_details is null :", "YES");
            }
