...
public class ComfortCoffeeTeaActivity extends AppCompatActivity {
    ...
    @BindView(R.id.rlmain_comfort_coffee_tea)
    RelativeLayout rlcomfort_coffee_tea;
    @BindView(R.id.tv_comfort_coffee_tea)
    TextView TVcomfort_coffee_tea;


    @BindView(R.id.tv_comfort_coffee_tea_aoname)
    TextView tvwelcome_accomodation;
    @BindView(R.id.iv_comfort_coffee_tea_image_one)
    ImageView aoImageOne;
    @BindView(R.id.iv_comfort_coffee_tea_image_two)
    ...
    String com_ct_details;
    DatabaseHandler db = new DatabaseHandler(this);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_comfort_coffee_tea);
        ...
        for (Contact cn : contacts) {
            String log =
                    "Id: " + cn.getID()
                            ...
                            + " ,getcom_ct_details: " + cn.getcom_ct_details()
                            + " ,geta_logo_image: " + cn.geta_logo_image()
                            + " ,geta_picture_image: " + cn.geta_picture_image()
                            + " ,getname: " + cn.getname();
            // Writing Contacts to log
            Log.e(" ^^^^^^ ^^^^^^^ ^^^ Comfort Coffee Tea Sqlite data ^^^^^^ ^^^^^^^ ^^^ : ", log);

            com_ct_details = cn.getcom_ct_details();
...
//                    tvwelcomparent.setText(Html.fromHtml(a_welcome));
            ...
            if (com_ct_details !=null  && !com_ct_details.isEmpty()){
                Log.e("ser_tv_details is NOT null :", "YES");
                TVcomfort_coffee_tea.setText(com_ct_details);
            }else {
                rlcomfort_coffee_tea.setVisibility(View.GONE);
                Log.e("com_ct_details is null :", "YES");
            }
