...
public class ComfortRoomServicesActivity extends AppCompatActivity {
    ...
    @BindView(R.id.rlmain_comfort_room_services)
    RelativeLayout rlcomfort_room_services;

    @BindView(R.id.tv_comfort_room_services)
    TextView TVcomfort_room_services;

    String com_room_details;
    DatabaseHandler db = new DatabaseHandler(this);

    @BindView(R.id.tv_comfort_room_aoname)
    TextView tvwelcome_accomodation;
    @BindView(R.id.iv_comfort_room_image_one)
    ImageView aoImageOne;
    @BindView(R.id.iv_comfort_room_image_two)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comfort_room_services);
        ...
        for (Contact cn : contacts) {
            String log =
                    "Id: " + cn.getID()
                            ...
                            + " ,getcom_room_details: " + cn.getcom_room_details()
                            + " ,geta_logo_image: " + cn.geta_logo_image()
                            + " ,geta_picture_image: " + cn.geta_picture_image()
                            + " ,getname: " + cn.getname();
            // Writing Contacts to log
            Log.e(" ^^^^^^ ^^^^^^^ ^^^ Comfort Room Services Sqlite Data ^^^^^^ ^^^^^^^ ^^^ : ", log);

            com_room_details = cn.getcom_room_details();
...
//                    tvwelcomparent.setText(Html.fromHtml(a_welcome));
            ...
            if (com_room_details !=null  && !com_room_details.isEmpty()){
                Log.e("com_room_details is NOT null :", "YES");
                TVcomfort_room_services.setText(com_room_details);
            }else {
                rlcomfort_room_services.setVisibility(View.GONE);
                Log.e("com_room_details is null :", "YES");
            }

            Log.e(" << SQLite DATA FOR com_room_details  >>: ", "" + log);
